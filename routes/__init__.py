...
def register_routes(app):
    app.register_blueprint(authentications_blueprint, url_prefix="/auth")
    # app.register_blueprint(images_blueprint, url_prefix="/image")
    # app.register_blueprint(interactions_blueprint, url_prefix="/interact")
